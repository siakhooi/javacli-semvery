...
class SemveryisLowerTest {
    ...
    private static Stream<Arguments> testIsLower() {
        ...
        for (String o : TestData.OPERATIONS) {
            a.addAll(createArguments("all-lower-2.0.0", ok, o, OPERATOR, DEFAULT,
                    TestData.ALL_LOWER_2_0_0));
            a.addAll(createArguments("all-lower-2.0.0", ok, o, OPERATOR, ANY,
                    TestData.ALL_LOWER_2_0_0));

            a.addAll(createArguments("all-not-lower-2.0.0", nok, o, OPERATOR, DEFAULT,
                    TestData.ALL_NOT_LOWER_2_0_0));
            a.addAll(createArguments("all-not-lower-2.0.0", nok, o, OPERATOR, ANY,
                    TestData.ALL_NOT_LOWER_2_0_0));
            ...
            a.addAll(createArguments("mixed-lower-not-lower-2.0.0", nok, o, OPERATOR, DEFAULT,
                    TestData.LOWER_NOT_LOWER_2_0_0));
            a.addAll(createArguments("mixed-lower-not-lower-2.0.0", ok, o, OPERATOR, ANY,
                    TestData.LOWER_NOT_LOWER_2_0_0));

            a.addAll(createArguments("mixed-lower-2.0.0-not-valid", nok, o, OPERATOR, DEFAULT,
                    TestData.LOWER_2_0_0_NOT_VALID));
            a.addAll(createArguments("mixed-lower-2.0.0-not-valid", ok, o, OPERATOR, ANY,
                    TestData.LOWER_2_0_0_NOT_VALID));

            a.addAll(createArguments("mixed-not-lower-2.0.0-not-valid", nok, o, OPERATOR, DEFAULT,
                    TestData.NOT_LOWER_2_0_0_NOT_VALID));
            a.addAll(createArguments("mixed-not-lower-2.0.0-not-valid", nok, o, OPERATOR, ANY,
                    TestData.NOT_LOWER_2_0_0_NOT_VALID));

            a.addAll(createArguments("mixed-lower-not-lower-2.0.0-not-valid", nok, o, OPERATOR, DEFAULT,
                    TestData.LOWER_NOT_LOWER_2_0_0_NOT_VALID));
            a.addAll(createArguments("mixed-lower-not-lower-2.0.0-not-valid", ok, o, OPERATOR, ANY,
                    TestData.LOWER_NOT_LOWER_2_0_0_NOT_VALID));
        }
